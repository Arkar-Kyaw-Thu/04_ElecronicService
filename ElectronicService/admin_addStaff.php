...
<?php 
  ...
  if(isset($_POST['add'])){
    ...
    $salary = $_POST['salary'];
    $about = $_POST['about'];
    $query="INSERT INTO `staff_info`(`staff_img`, `staff_name`, `position`, `work_experience`, `team` , `address` , `phno` , `about` , `salary` , `status`) VALUES ('$filename','$name','$position','$work_experience','$team','$address','$phno','$about','$salary','free')";
          ...
          <div class="history-main-card">
            <div class="history-card" style="background: #;">
              ...
              <div class="history-card-inner">
                ...
                <input type="text" name="work_experience" id="work_experience" autocomplete="off" required>
              </div>
              <div class="history-card-inner">
            ...
            <div class="history-card" style="background: #;">
              <div class="history-card-inner">
                ...
                <input type="text" name="address" id="work_experience" autocomplete="off" required>
              </div>
              <div class="history-card-inner">
                <label for="work_experience">Phone Number</label>
                <input type="text" name="phno" id="work_experience" autocomplete="off" required>
              </div>
              <div class="history-card-inner">
                <label for="work_experience">Salary</label>
                <input type="text" name="salary" id="work_experience" autocomplete="off" required>
              </div>
              <div class="history-card-inner">
              ...
              <div class="history-card-inner">
                <input type="submit" class="btn" name="add" value="ADD" required style="margin: auto;">
              </div>
            </div>
          </div>
        </form>
